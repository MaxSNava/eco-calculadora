...
type AppState = {
  ...
  // funcion para poner la data
  setData: (d: Partial<AppData>) => void;
  // TODO: funcion para actualizar la data
  updateData: () => void;
  // funcion para sabe si todas las secciones estan completas para generar el pdf
  isComplete: () => void;
};
...
const initial: AppData = {
  general: {
    ...
    assistants: 0,
    staff: 0,
    // Esta es una constante siempre va a valer 30 dolares el arbol || muy raro que cambie
    treeCost: 30,
  },
  transport: {
